...
import 'perfil_beneficiario_model.dart';
export 'perfil_beneficiario_model.dart';

class PerfilBeneficiarioWidget extends StatefulWidget {
  const PerfilBeneficiarioWidget({super.key});

  static String routeName = 'PerfilBeneficiario';
  static String routePath = '/perfilBeneficiario';

  @override
  State<PerfilBeneficiarioWidget> createState() =>
      _PerfilBeneficiarioWidgetState();
}

class _PerfilBeneficiarioWidgetState extends State<PerfilBeneficiarioWidget> {
  late PerfilBeneficiarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilBeneficiarioModel());
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<UsuariosRecord>>(
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          safeSetState(() => _model
                                                  .isDataUploading_fotoPerfilBeneficiario =
                                              true);
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_fotoPerfilBeneficiario =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_fotoPerfilBeneficiario =
                                        ...
                                        _model.foto =
                                          ...
                                          image: _model
                                              .uploadedLocalFile_fotoPerfilBeneficiario,
                                        );

                                        await containerUsuariosRecord!.reference
                                            .update(createUsuariosRecordData(
                                          fotoPerfil: getJsonField(
                                            (_model.foto?.jsonBody ?? ''),
                                            r'''$.data.url''',
                                          ).toString(),
                                        ));
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller: _model
                                        ...
                                        text: containerUsuariosRecord?.nome,
                                      ),
                                      focusNode:
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.cPFfieldTextController ??=
                                              TextEditingController(
                                        text: containerUsuariosRecord?.cpf,
                                      ),
                            ...
                            StreamBuilder<List<CidadesRecord>>(
                              stream: queryCidadesRecord(
                                queryBuilder: (cidadesRecord) =>
                                    cidadesRecord.where(
                                  'id_cidade',
                                  isEqualTo: containerUsuariosRecord?.endereco,
                                ),
                                singleRecord: true,
                              ),
                              builder: (context, snapshot) {
                                  ...
                                  if (_model.dropDownestValue != null &&
                                    ...
                                    if (_model.dropDownValue != null &&
                                      ...
                                      await containerUsuariosRecord!.reference
                                        ...
                                        telefone:
                                            containerUsuariosRecord?.telefone,
                                        email: '',
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(PaginaAnuncioWidget.routeName);
                              },
                              child: Text(
                                'Cancelar',
                                style: FlutterFlowTheme.of(context)
                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          context
                              .pushNamed(HistoricoBeneficiarioWidget.routeName);
                        },
                      ),
                      FlutterFlowIconButton(
                        borderRadius: 8.0,
