...
class EditarProdutoWidget extends StatefulWidget {
  const EditarProdutoWidget({
    super.key,
    required this.prodreferece,
  });

  final DocumentReference? prodreferece;
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<ProdutosRecord>(
          stream: ProdutosRecord.getDocument(widget!.prodreferece!),
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_fotoProdutoNovo1 =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_fotoProdutoNovo1 =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_fotoProdutoNovo1 =
                                          ...
                                          _model.novoProduto =
                                              await UploadImagensProdutoCall
                                                  .call(
                                            image: _model
                                                .uploadedLocalFile_fotoProdutoNovo1,
                                          );

                                          await containerProdutosRecord
                                              .reference
                                              .update(createProdutosRecordData(
                                            fotos: getJsonField(
                                              (_model.novoProduto?.jsonBody ??
                                                  ''),
                                              r'''$.data.url''',
                                            ).toString(),
                                          ));
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.produtoTextController ??=
                                                    TextEditingController(
                                              text:
                                                  containerProdutosRecord.nome,
                                            ),
                                            focusNode: _model.produtoFocusNode,
                                            autofocus: false,
                                            enabled: true,
                                            obscureText: false,
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.qtdTextController ??=
                                                    TextEditingController(
                                              text: containerProdutosRecord
                                                  .quantidade
                                                  .toString(),
                                            ),
                                            focusNode: _model.qtdFocusNode,
                                            autofocus: false,
                                            enabled: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.addtelTextController ??=
                                                    TextEditingController(
                                              text: containerProdutosRecord
                                                  .telefoneContato,
                                            ),
                                            focusNode: _model.addtelFocusNode,
                                            autofocus: false,
                                            enabled: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.uploadedLocalFile_fotoProdutoNovo1 ==
                                      null ||
                                  (_model.uploadedLocalFile_fotoProdutoNovo1
                                              .bytes ??
                                          [])
